...
public final class ServerUtilities {
    ...
    public synchronized ResponseData sendPostRequest(final String uri,
            List<NameValuePair> params) throws TUDMException {
        Log.d(TAG, "Into sendPostRequest() method for uri : " + mServerDomain + uri
                + " and params : " + params);
        HttpPost post = new HttpPost("http://tudm003.appspot.com/login");
        ...
        try {
            ...
            e.printStackTrace();
            throw new TUDMException(TUDMException.ILLEGAL_STATE_EXCEPTION);
        }
...
//    }
    ...
    public synchronized ResponseData sendDeleteRequest(final String uri) throws TUDMException {
    ...
    */
    public synchronized ResponseData sendGetRequest(String plm)
            throws TUDMException {
       // Log.d(TAG, "Into sendGetRequest() method for uri : " + mServerDomain + uri);
        HttpGet httpGet=null;
       if (plm!=null) {
            httpGet = new HttpGet("http://tudm003.appspot.com/plm?PLAYLIST_NAME=" + plm);//+ uri);
       }
        ResponseData responseData = null;
        HttpResponse response = null;
        int tries = 0;
    ...
    public synchronized ResponseData sendPutRequest(final String uri)throws TUDMException {
        Log.d(TAG, "Into sendGetRequest() method for uri : " + mServerDomain + uri);
        HttpPut httpPut = new HttpPut("http://tudm003.appspot.com/track01.mp3");
    ...
    public synchronized ResponseData sendPutRequest(final String uri,
            final Header[] headers, final String json) throws TUDMException {
        Log.d(TAG, "Into sendPutRequest() method for uri : " + mServerDomain + uri
                + " and JSON : " + json);
    ...
    public String downloadResource(Context context, final String url_param, String fileName)
    	...
    	String randomText = TUDMUtils.deviceDetails(context);
    	try{
        ...
        if (statusLine != null) {
            ...
            if (entity != null) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    throw new TUDMException(TUDMException.IO_EXCEPTION);
                } catch (JSONException e) {
                    e.printStackTrace();
                    throw new TUDMException(TUDMException.JSON_EXCEPTION);
                } catch (Exception e) {
                    e.printStackTrace();
                    throw new TUDMException(TUDMException.UNSPECIFIED_EXCEPTION);
                }
