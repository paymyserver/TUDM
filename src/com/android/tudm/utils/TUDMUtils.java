...
public class TUDMUtils {
	private static final String TAG = TUDMUtils.class.getSimpleName();
	...
	public static String deviceDetails(Context context){
		...
		return "&"+RemoveSpace(TUDMUtils.getDeviceAndSdkVersion(context)+"_"+ TUDMUtils.getUUID(context, username)+
