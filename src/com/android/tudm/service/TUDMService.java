...
import com.android.tudm.model.Album;
...
import com.turnupdmood.tudm.TUDMPlayer;
 ...
 * Starts usually by {@link com.turnupdmood.tudm.TUDMPlayer} activity once the {@link Song} or
 * {@link Message} is received from server.<br>
 * It needs to be stopped once track ended. And starts again for the next track.<br>
 * {@link TUDMService} keeps running in the background even though user moves out
 ...
 *
 */
public class TUDMService extends Service implements
    ...
    private static final String TAG = TUDMService.class.getSimpleName();
    // Singleton instance of the CCMService.
    private static TUDMService mInstance = null;
    ...
    private TUDMListener mListener;
    ...
    private void initMediaPlayer() {
        try {
            if (mTrack!=null && !TextUtils.isEmpty(mTrack.getSongPath())) {
                ...
                throw new TUDMException(TUDMException.UNSPECIFIED_EXCEPTION);
            }
        } catch (Exception e) {
            e.printStackTrace();
            ...
            TUDMApplication.removeCachedTrack();
        }
    ...
    /**
     * Start playing track as mentioned by {@link #mSong} or {@link #mMessage}.
     */
    ...
    /**
     * Sets the {@link TUDMListener} callback. {@link com.turnupdmood.tudm.TUDMPlayer} needs to listen
     * to this callback.
     *
     * @param listener
     */
    public void setCCMListener(TUDMListener listener) {
        mListener = listener;
    }

    /**
     * Removes {@link TUDMListener} callback. Called by {@link com.turnupdmood.tudm.TUDMPlayer}.
     */
    ...
    public static TUDMService getInstance() {
        return mInstance;
    }


    /**
     * Sets the {@link Song} to be played from the cache.. Called by {@link com.turnupdmood.tudm.TUDMPlayer} when a
    ...
    public Notification getNotification(int type, Bitmap albumart) {
        ...
        final RemoteViews remoteViews = new RemoteViews(getPackageName(),
                R.layout.tudm_custom_notification_layout);

        Intent activityIntent = new Intent(this,TUDMPlayer.class);
