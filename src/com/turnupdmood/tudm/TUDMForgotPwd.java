 ...
 * 
 */
public class TUDMForgotPwd extends Activity {
    private static final String TAG = TUDMForgotPwd.class.getSimpleName();
    EditText mUsername;
    EditText mEmailId;
    Button mSubmit;
 ...
 // add custom font for text view
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tudm_forgotpwd_screen_layout);
        init();
    ...
    public void init() {
        ...
        mDialog = new Dialog(TUDMForgotPwd.this);
    ...
    class ForgotPasswordTaskAsync extends AsyncTask<Void, String, String> {
        ...
        ProgressDialog asyncDialog = new ProgressDialog(TUDMForgotPwd.this);
    ...
    protected ResponseData sendForgotPasswordRequest(String username,
            String email) throws TUDMException {
