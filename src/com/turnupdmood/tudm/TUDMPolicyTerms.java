...
public class TUDMPolicyTerms extends Activity {
    private static final String TAG = TUDMPolicyTerms.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tudm_privacy_terms_screen_layout);
