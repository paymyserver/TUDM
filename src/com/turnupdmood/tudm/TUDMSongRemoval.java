...
import com.android.tudm.model.SongRemovalModal;
 ...
 *
 */
public class TUDMSongRemoval extends Activity {
    private static final String TAG = TUDMSongRemoval.class.getSimpleName();
    MediaPlayer mPlayer;
 ...
 // add custom font for text view
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tudm_removeong_screen_layout);
       
        init();
        activity=TUDMSongRemoval.this;
    ...
    private class PlayListAsyncTask extends AsyncTask<Object, Object, String> {
        ...
        public PlayListAsyncTask() {
            ...
            asyncDialog=new ProgressDialog(TUDMSongRemoval.this);
        ...
        protected String doInBackground(Object... params) {
            ...
            try {
                if(!ServerUtilities.isNetworkAvailable(TUDMSongRemoval.this)){
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                             ...
                             // Parse the json response.
                                ...
                                if(songModal!=null && itemList!=null){
                                   if(itemList.size()<songCount && !TUDMApplication.isTrackCached(songModal.getName())){
            ...
            }catch (TUDMException TUDMException){
                Log.d(TAG, ""+ TUDMException.getMessage());
            }
            catch (Exception e) {
    ...
    private class SongRemovalListAdapter extends ArrayAdapter{
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            LayoutInflater inflater = (LayoutInflater) context
                ...
                if(mItem!=null){
                    if(convertView==null){
                        convertView = inflater.inflate(R.layout.tudm_removesong_layout, null);
    ...
    private ResponseData sentPreviousSongRequest() throws TUDMException {
        Context context = getApplicationContext();
    ...
    class RemoveAsynctask extends AsyncTask<Void, Void, String>{
        ...
        RemoveAsynctask(){
            mAsyncDialog=new ProgressDialog(TUDMSongRemoval.this);
    ...
    private void showToast(final String msg) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(TUDMSongRemoval.this, msg, Toast.LENGTH_LONG).show();
            }
        });
    }
 ...
 private int gettMediaID() {
    ...
    class getTrack extends AsyncTask<Void,Void,Void> 
	{
		...
		protected Void doInBackground(Void... params) {
			// TODO Auto-generated method stub
			mFilePath=downloadResource(TUDMSongRemoval.this,
					mPath,
					"preview");
			return null;
		}
					  ...
					  public void onPrepared(MediaPlayer mp) {
						  cntr_aCounter = new CountDownTimer(30000, 1000) {
						        public void onTick(final long millisUntilFinished) {
						        	...
						        	TUDMSongRemoval.this.mPlayer= mPlayer;
						        	 // TODO do your thing
