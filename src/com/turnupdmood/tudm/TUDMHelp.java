 ...
 * This activity can be launched from {@link TUDMLogin} or {@link TUDMPlayer}.
 * 
 * @author Mahesh Chauhan
 * 
 */
public class TUDMHelp extends Activity {
    private static final String TAG = TUDMHelp.class.getSimpleName();
    ...
    private void bindDataToViews() {
        ...
        if (extras != null) {
            ...
            if (type == NEED_HELP_TYPE_LOGIN) {
                setContentView(R.layout.tudm_login_help_screen_layout);
                init();
                ...
                setContentView(R.layout.tudm_help_screen_layout);
                init();
